...
class BitMex implements BrokerClientInterface
{
  ...
  public function __construct() {
    ...
    $keys = new ReadKeys(__DIR__."/../../config/apikey.json");
    $this->apiKey = $keys->id;
   ...
   */
   ...
   public function editOrder($orderID, $price = NULL, $size = NULL, $stop = NULL)
   {
     $data['method'] = "PUT";
     $data['function'] = "order";
     $data['params'] = array(
  ...
  public function editOrderSize($orderID,$quantity) {
   ...
   *
   * $type, $side, $price, $quantity, $stop = NULL, $execInst = NULL
   */
  ...
  public function createOrders(array $orders) {
    ...
    return $this->authQuery($orders_array);
  }
